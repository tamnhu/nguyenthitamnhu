...
require_once 'lib/scss.inc.php';
    ...
    $styles = $scss->compile('@import "1736-styles.scss";');

    $css = fopen('css/1736-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1736-styles.css" rel="stylesheet" type="text/css" />
